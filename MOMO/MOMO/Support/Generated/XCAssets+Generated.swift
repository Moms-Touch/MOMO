...
internal enum Asset {
  internal enum Assets {
    ...
    internal static let birdAngryDefault = ImageAsset(name: "bird.angry.default")
    internal static let birdBlueDefault = ImageAsset(name: "bird.blue.default")
    internal static let birdHappyDefault = ImageAsset(name: "bird.happy.default")
    internal static let birdSadDefault = ImageAsset(name: "bird.sad.default")
    ...
    internal static let polygon3 = ImageAsset(name: "Polygon 3")
    ...
    internal static let koreaSinglemomNetwork = ImageAsset(name: "koreaSinglemomNetwork")
